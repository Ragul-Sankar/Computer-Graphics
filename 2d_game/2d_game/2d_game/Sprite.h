...
class Sprite
{
    ...
    public: void drawSprite();           // Enter sprite into graphics pipeline
    public: void advance_frame(int,int); // Advance frame_no between two bounds
    public: void advance_projectile();   // Advance movement of sprite 
	public: bool collision(Sprite);      // Detect collision between sprites
